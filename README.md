...
<ol>
  ...
  <li><b> Merge Sort </b>
    <p> Keeps dividing the Array; after completely dividing, sorts the single elemet arrays by comparing and merges them one by one. Faster sorting at the cost of some extra memory. </p>
    <table>
      <tr>
        <th>Worst Case</th>
        <th>Average Case</th>
